    ...
    $.ajax({
        ...
        success : function(dat) {
            ...
            if(recentList.size() > 0){
                ...
                // $('.notice .list').html("<div class='empty-data' style='text-align:center;font-size:18px;'><b>鏆傛棤鏁版嵁</b></div>");
            }
        }
    });
    $.ajax({
